...
void creditLIST()
{
 ...
 glOrtho(0.0, 800.0, 800.0, 0.0, -1.0, 1.0);   // setup a 10x10x2 viewing world
  ...
  glMatrixMode(GL_MODELVIEW);
   ...
   printLINEc(200,200,"-----BHILAI INSTITUTE OF TECHNOLOGY DURG----");
   printLINEc(200,220,"-----ELECTRONICS AND TELECOMMUNICATIONS----");
   glColor3f(0, 0, 0);

   printLINEc(200,320,"---NISHANT KUMAR SAHU---");
   printLINEc(200,340,"---SHIVAM JOSHI---");
   printLINEc(200,360,"---ANMOL SONI---");

   printLINEc(200,400,"----TEAM VICIOUS----");

   printLINEc(50,680,"Total lines CODED-- 4944");
   printLINEc(50,700,"Completed- 24/AUG/2022");
